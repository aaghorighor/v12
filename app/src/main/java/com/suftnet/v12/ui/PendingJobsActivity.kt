...
class PendingJobsActivity : BaseAppCompatActivity() {
    companion object {
        const val TAG = "PendingJobsActivity"
    }
    ...
    private fun listener()
    {
        back_action.setOnClickListener {
            var i = Intent(this@PendingJobsActivity, DriverDashboardActivity::class.java)
        ...
        jobAdapter.setOnItemClickListener(object:JobAdapter.OnItemClickListener {
            override fun onView(order: Order, position: Int) {
                var i = Intent(this@PendingJobsActivity, JobDetailActivity::class.java)
