...
class BuyerCompletedOrderActivity : BaseAppCompatActivity() {
    companion object {
        const val TAG = "BuyerCompletedOrderActivity"
    }
    ...
    private fun listener()
    {
        back_action.setOnClickListener {
            var i = Intent(this@BuyerCompletedOrderActivity, BuyerDashboardActivity::class.java)
        ...
        orderAdapter.setOnItemClickListener(object:OrderAdapter.OnItemClickListener {
            override fun onView(order: Order, position: Int) {
                var i = Intent(this@BuyerCompletedOrderActivity, BuyerOrderDetailActivity::class.java)
